...
function sendMessage(destTargetId, destRoom) {
    ...
    if (destRoom || destGroup) {
        ...
        easyrtc.showError("USUÁRIO ERRADO", "DESTINO INVÁLIDO");
        return;
    }
...
function loginSuccess(easyrtcid) {
    ...
    document.getElementById("iam").innerHTML = "MEU ID " + easyrtcid;
    refreshRoomList();
    isConnected = true;
    displayFields();
    document.getElementById("main").className = "CONECTADO";
}
